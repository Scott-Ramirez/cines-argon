    ...
    <div className="fixed bottom-6 right-6 z-40 no-print flex items-center gap-3">
      ...
      >
        ...
        <span className="font-semibold font-sans">
          ¿Dudas o Reservas? <strong className="text-emerald-400">¡Escríbenos!</strong>
        </span>
      </div>
      ...
      <a
        ...
        className="relative group w-14 h-14 rounded-full bg-gradient-to-tr from-emerald-600 via-[#25D366] to-emerald-400 text-white flex items-center justify-center shadow-2xl shadow-emerald-500/50 hover:shadow-emerald-500/80 transition-all duration-300 transform hover:scale-110 active:scale-95"
        title="Contactar por WhatsApp (+51 920 569 220)"
      >
        {/* Radar Pulse Effect */}
        ...
        <svg
          className="w-8 h-8 fill-current drop-shadow-md relative z-10"
          viewBox="0 0 24 24"
        >
        ...
        <span className="absolute top-0 right-0 w-4 h-4 bg-emerald-400 border-2 border-slate-950 rounded-full flex items-center justify-center">
